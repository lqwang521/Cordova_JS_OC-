...
#import "HTMICDVHandleOpenURL.h"
#import "HTMICDV.h"

@implementation HTMICDVHandleOpenURL

- (void)pluginInitialize
{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(applicationLaunchedWithUrl:) name:HTMICDVPluginHandleOpenURLNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(applicationPageDidLoad:) name:HTMICDVPageDidLoadNotification object:nil];
}
