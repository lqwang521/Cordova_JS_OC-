...
NSString* const kHTMICDVAssetsLibraryPrefixes = @"assets-library://";

@implementation HTMICDVURLProtocol
...
+ (BOOL)canInitWithRequest:(NSURLRequest*)theRequest
{
    ...
    if ([[theUrl absoluteString] hasPrefix:kHTMICDVAssetsLibraryPrefixes]) {
        return YES;
    }
...
- (void)startLoading
{
    ...
    if ([[url absoluteString] hasPrefix:kHTMICDVAssetsLibraryPrefixes]) {
