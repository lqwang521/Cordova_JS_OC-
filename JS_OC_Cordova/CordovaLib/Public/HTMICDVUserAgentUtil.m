...
static NSString* const kHTMICDVUserAgentKey = @"Cordova-User-Agent";
static NSString* const kHTMICDVUserAgentVersionKey = @"Cordova-User-Agent-Version";
...
@implementation HTMICDVUserAgentUtil
...
+ (NSString*)originalUserAgent
{
    if (gOriginalUserAgent == nil) {
        ...
        NSString* cordovaUserAgentVersion = [userDefaults stringForKey:kHTMICDVUserAgentVersionKey];
        gOriginalUserAgent = [userDefaults stringForKey:kHTMICDVUserAgentKey];
        ...
        if ((gOriginalUserAgent == nil) || cachedValueIsOld) {
            ...
            [userDefaults setObject:gOriginalUserAgent forKey:kHTMICDVUserAgentKey];
            [userDefaults setObject:systemAndLocale forKey:kHTMICDVUserAgentVersionKey];
